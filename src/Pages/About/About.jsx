      ...
      <div className="px-6 py-10 lg:py-16 max-w-7xl mx-auto md:py-20 flex flex-col lg:flex-row  items-center gap-16 mb-16">
        ...
        <div className="w-full lg:w-1/2 space-y-5 lg:pl-6 text-center lg:text-left ">
          <h2 className="text-3xl sm:text-4xl font-bold ">
            Discover Transit: Your Logistics Partner Discover Transit: Your
            Logistics Partner
          </h2>
          ...
          <div className="flex gap-x-10 mt-12">
            <button className="b px-7 bg-black text-white hover:text-black hover:bg-white rounded-md py-2 font-semibold">
              Contact Us
            </button>
            <button className="b px-5 bg-white text-black hover:text-white hover:bg-black rounded-md py-3 font-semibold">
              Schedule A Call
            </button>
          </div>
        </div>
